...
model.load_state_dict(torch.load('D:\\braintumor\\brain-t\\best_model.pth'))
model.to(device)
model.eval()
...
# Path to the image
image_path = 'D:\\braintumor\\brain-t\\glioma.jpeg'  # replace with your image path
...
train_dataset = ImageFolder('D:\\braintumor\\brain-t\\archive\\Training', transform=data_transforms)
...
output_path = 'D:\\braintumor\\brain-t\\prediction_result.png' 
