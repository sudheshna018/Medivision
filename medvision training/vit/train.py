...
val_dataset = ImageFolder('D:\\hirmuzesh\\vit-brain-tumor\\archive\\Testing', transform=data_transforms)
...
plt.savefig('D:\\hirmuzesh\\vit-brain-tumor\\classes.png')  
plt.close()
...
for epoch in range(num_epochs):
    ...
    if val_accuracy > best_val_accuracy:
        ...
        torch.save(model.state_dict(), 'D:\\hirmuzesh\\vit-brain-tumor\\best_model.pth')
...
plt.tight_layout()
plt.savefig('D:\\hirmuzesh\\vit-brain-tumor\\loss.png')  
plt.close()
...
plt.tight_layout()
plt.savefig('D:\\hirmuzesh\\vit-brain-tumor\\accuracy.png')  
plt.close()
...
plt.savefig('D:\\hirmuzesh\\vit-brain-tumor\\confusion_matrix.png')  
plt.close()
